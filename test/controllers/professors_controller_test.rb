...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { dept_name: @professor.dept_name, prof_email: @professor.prof_email, prof_first_name: @professor.prof_first_name, prof_info: @professor.prof_info, prof_last_name: @professor.prof_last_name } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { dept_name: @professor.dept_name, prof_email: @professor.prof_email, prof_first_name: @professor.prof_first_name, prof_info: @professor.prof_info, prof_last_name: @professor.prof_last_name } }
