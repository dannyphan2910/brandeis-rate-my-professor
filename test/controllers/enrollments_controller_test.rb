...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post enrollments_url, params: { enrollment: { general_course_id: @enrollment.general_course_id, user_id: @enrollment.user_id } }
  #   end
  ...
  #   patch enrollment_url(@enrollment), params: { enrollment: { general_course_id: @enrollment.general_course_id, user_id: @enrollment.user_id } }
