...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { likes_participation: @preference.likes_participation, likes_testing: @preference.likes_testing, likes_workload: @preference.likes_workload, user_id: @preference.user_id } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { likes_participation: @preference.likes_participation, likes_testing: @preference.likes_testing, likes_workload: @preference.likes_workload, user_id: @preference.user_id } }
